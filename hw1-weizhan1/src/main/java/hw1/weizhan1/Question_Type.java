...
public class Question_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("hw1.weizhan1.Question");
  ...
  public int getTokenArray(int addr) {
      ...
      jcas.throwFeatMissing("tokenArray", "hw1.weizhan1.Question");
  ...
  public int getBegin(int addr) {
      ...
      jcas.throwFeatMissing("begin", "hw1.weizhan1.Question");
  ...
  public int getEnd(int addr) {
      ...
      jcas.throwFeatMissing("end", "hw1.weizhan1.Question");
  ...
  public String getProcID(int addr) {
      ...
      jcas.throwFeatMissing("procID", "hw1.weizhan1.Question");
  ...
  public double getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "hw1.weizhan1.Question");
